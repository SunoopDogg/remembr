...
from vila.llava.data.collate import DataCollator
...
from vila.llava.train.sequence_parallel import (
...
class LazyVideoWebDataset(Dataset):
    ...
    def __init__(
        ...
        # from vila.llava.data.simple_video_dataset import SimpleVideoDataset
