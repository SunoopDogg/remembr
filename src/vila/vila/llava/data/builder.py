...
from vila.llava.data.datasets_mixture import DATASETS_LEGACY
from vila.llava.train.args import DataArguments, TrainingArguments
from vila.llava.utils import io
...
def build_dataset_legacy(
    ...
    from vila.llava.data.dataset import (
        LazyCCSWebDataset,
        LazyCoyoDataset,
        LazyCoyoWebDataset,
        LazyMMC4Dataset,
    ...
    from vila.llava.data.dataset_impl.coyo_recap import LazyCoyoWebRecapDataset
    from vila.llava.data.dataset_impl.general_img_text import LazyImageTextWebDataset
    from vila.llava.data.dataset_impl.hiertext import VILAHierText
    from vila.llava.data.dataset_impl.panda70m import VILAPanda70m
    from vila.llava.data.dataset_impl.sam import LazySAMWebDataset
    from vila.llava.data.dataset_impl.textocr import VILATextOCR
    ...
    if dataset_type == "torch":
        ...
        from vila.llava.data.dataset_impl.coyo_qa import LazyCoyoWebQADataset
