...
from vila.llava.data.dataset import LazySupervisedDataset
from vila.llava.data.dataset_impl.textocr import GenericDataset, preprocess_OCR
from vila.llava.data.simple_vila_webdataset import VILAWebDataset
from vila.llava.data.utils import VILAEncodedVideo
from vila.llava.mm_utils import is_gemma_tokenizer, tokenizer_image_token
...
class VILAPanda70m(Dataset):
    ...
    def __getitem__(self, index):
        ...
        from vila.llava.mm_utils import opencv_extract_frames
