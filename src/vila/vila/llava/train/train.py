...
import vila.llava.data.dataset as dataset
import vila.llava.data.datasets_mixture as datasets_mixture
from vila.llava import conversation as conversation_lib
from vila.llava.constants import IGNORE_INDEX
from vila.llava.data import make_supervised_data_module
from vila.llava.mm_utils import process_image
from vila.llava.model import LlavaLlamaConfig, LlavaLlamaModel, LlavaTopDownLlamaConfig, LlavaTopDownLlamaModel
from vila.llava.model.language_model.fp8linearqwen2 import Qwen2ForCausalLM  # We need this line to register AutoConfig
from vila.llava.model.language_model.qllava_qllama import QLlavaLlamaModel, quantize_args_to_model_class
from vila.llava.train.args import DataArguments, ModelArguments, TrainingArguments
from vila.llava.train.callbacks.autoresume_callback import AutoResumeCallback
from vila.llava.train.llava_trainer import LLaVATopDownTrainer, LLaVATrainer, VILADPOTrainer
from vila.llava.train.sequence_parallel import set_pg_manager
from vila.llava.train.slurm_utils import TimeoutTerminateCallback
from vila.llava.train.utils import (
    get_checkpoint_path,
    mprint,
...
from vila.llava.trl.trainer.utils import DPODataCollatorWithPadding
...
`"""
    ...
    if resume_path:
        ...
        if model_args.ps3:
            ...
            if (
                ...
                from vila.llava.model.language_model.qllava_qllama import QLlavaLlamaModel
    ...
    if training_args.dpo:
        ...
        if model_args.quantize_model in ["fp8Activation_qwen2", "fp8ActivationResidual_qwen2"]:
            from vila.llava.model.coat.fp8_trainer import CoatFP8Trainer
